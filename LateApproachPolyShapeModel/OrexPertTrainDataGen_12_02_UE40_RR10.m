...
mcEnd1SigVelJ2000_1 = [1.8848e-05; 1.1966e-05; 1.0358e-05]*1;
mcEnd1SigVelJ2000_2 = [1.8848e-05; 1.1966e-05; 1.0358e-05]*1;
...
start
%}
raDec1 = [333.37515; 2.62268];
raDec2 = [333.65932; 1.18247];
raDec3 = [331.70478; 0.78114];
...
%}
raDec1 = [330.03702; 2.19841];
raDec2 = [330.37368; 0.50305];
raDec3 = [327.95173; 0.00262];
...
MosCovProbStartX1 = sum(MosCovStartSigX >= 1)/(nTD*vTD);
MosCovProbStartY1 = sum(MosCovStartSigY >= 1)/(nTD*vTD);
MosCovProbEndX1 = sum(MosCovEndSigX >= 1)/(nTD*vTD);
MosCovProbEndY1 = sum(MosCovEndSigY >= 1)/(nTD*vTD);
MosCovProbStartX2 = sum(MosCovStartSigX >= 2)/(nTD*vTD);
MosCovProbStartY2 = sum(MosCovStartSigY >= 2)/(nTD*vTD);
MosCovProbEndX2 = sum(MosCovEndSigX >= 2)/(nTD*vTD);
MosCovProbEndY2 = sum(MosCovEndSigY >= 2)/(nTD*vTD);
MosCovProbStartX3 = sum(MosCovStartSigX >= 3)/(nTD*vTD);
MosCovProbStartY3 = sum(MosCovStartSigY >= 3)/(nTD*vTD);
MosCovProbEndX3 = sum(MosCovEndSigX >= 3)/(nTD*vTD);
MosCovProbEndY3 = sum(MosCovEndSigY >= 3)/(nTD*vTD);
...
axis([0 10 0 1000])
xticks(0:1:10);
yo = ['P(X Mos Cov \geq 1) = ',num2str(MosCovProbStartX1,'%2.3f');...
    'P(Y Mos Cov \geq 1) = ',num2str(MosCovProbStartY1,'%2.3f');...
    'P(X Mos Cov \geq 2) = ',num2str(MosCovProbStartX2,'%2.3f');...
    'P(Y Mos Cov \geq 2) = ',num2str(MosCovProbStartY2,'%2.3f');...
    'P(X Mos Cov \geq 3) = ',num2str(MosCovProbStartX3,'%2.3f');...
    'P(Y Mos Cov \geq 3) = ',num2str(MosCovProbStartY3,'%2.3f')];
annotation(figure(3),'textbox',...
    [0.15 .8 0.2 0.1],...
    'String',yo,'FitBoxToText','on');
...
axis([0 10 0 1000])
xticks(0:1:10);
yo = ['P(X Mos Cov \geq 1) = ',num2str(MosCovProbEndX1,'%2.3f');...
    'P(Y Mos Cov \geq 1) = ',num2str(MosCovProbEndY1,'%2.3f');...
    'P(X Mos Cov \geq 2) = ',num2str(MosCovProbEndX2,'%2.3f');...
    'P(Y Mos Cov \geq 2) = ',num2str(MosCovProbEndY2,'%2.3f');...
    'P(X Mos Cov \geq 3) = ',num2str(MosCovProbEndX3,'%2.3f');...
    'P(Y Mos Cov \geq 3) = ',num2str(MosCovProbEndY3,'%2.3f')];
