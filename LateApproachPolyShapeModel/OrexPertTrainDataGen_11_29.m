...
mcEnd1SigStDevRtn_1 = [3.601; 1.892; 1.882];
mcEnd1SigStDevRtn_2 = [3.608; 1.901; 1.886];
...
mcEndMeanPosJ2000_1 = [-46.04367112; 3.30004784; -4.631262932];
mcEndMeanPosJ2000_2 = [-45.6954194; 3.428920501; -4.57517417];
...
mcEndMeanVelJ2000_1 = [9.67E-05; 3.58E-05; 1.56E-05];
mcEndMeanVelJ2000_2 = [9.68E-05; 3.58E-05; 1.56E-05];
...
mcEnd1SigVelJ2000_1 = [3.0199e-06; 1.6528e-06; 1.8628e-06]*1;
mcEnd1SigVelJ2000_2 = [3.0199e-06; 1.6528e-06; 1.8628e-06]*1;
...
start
%}
raDec1 = [359.29065; 6.69475];
raDec2 = [359.54391; 4.98213];
raDec3 = [357.84764; 4.72061];
...
%}
raDec1 = [358.62635; 6.70362];
raDec2 = [358.91532; 4.81314];
raDec3 = [357.03708; 4.51433];
...
trueUEstartX = 1.113340;
trueUEstartY = 1.128890;
