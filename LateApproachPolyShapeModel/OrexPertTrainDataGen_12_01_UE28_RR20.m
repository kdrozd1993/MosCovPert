...
mcEnd1SigStDevRtn_1 = [2.562; 1.893; 1.460];
mcEnd1SigStDevRtn_2 = [2.503; 1.871; 1.432];
...
mcEndMeanPosJ2000_1 = [-27.1471246; 10.16647007; -1.593264295];
mcEndMeanPosJ2000_2 = [-26.76797892; 10.30187059; -1.532123368];
...
mcEndMeanVelJ2000_1 = [0.000105223; 3.76E-05; 1.70E-05];
mcEndMeanVelJ2000_2 = [0.000105413; 3.76E-05; 1.70E-05];
...
mcEnd1SigVelJ2000_1 = [1.8823e-05; 1.1792e-05; 1.0222e-05]*1;
mcEnd1SigVelJ2000_2 = [1.8823e-05; 1.1792e-05; 1.0222e-05]*1;
[mcEnd1SigVelJ2000] = VecElementInterp (mcEnd1SigVelJ2000_1,mcEnd1SigVelJ2000_2, minEnd, secEnd);



CovStart1SigStDev_1 = [.4400; .1543; .1304];
...
CovEnd1SigStDev_1 = [0.4422; 0.1389; 0.1202];
CovEnd1SigStDev_2 = [0.4424; 0.1582; 0.1330];
...
start
%}
raDec1 = [346.60945; 4.67072];
raDec2 = [346.84957; 3.38976];
raDec3 = [345.49624; 3.12742];
...
%}
raDec1 = [343.01134; 4.33991];
raDec2 = [343.33978; 2.62992];
raDec3 = [341.46212; 2.2579];
